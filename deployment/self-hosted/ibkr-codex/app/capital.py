...
def protected_cash_floor(principal: Decimal, accrued_cash: Decimal, accrued_baseline: Decimal) -> Decimal:
    """Protect principal plus only interest accrued after the virtual account began."""
    return principal + max(Decimal("0"), accrued_cash - accrued_baseline)
