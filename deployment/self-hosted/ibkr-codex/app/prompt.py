...
Objective:
- Manage a medium/long-term growth portfolio of liquid US-listed stocks and ordinary, unleveraged ETFs.
...
- Confirm that every proposed instrument is a liquid US-listed stock or ordinary unleveraged ETF, trades above $5, and is suitable for whole-share execution.
- Treat supplied News Signal data as exploratory context, never as proof or causal evidence.
- Do not recommend shorting, margin, options, futures, forex, crypto, penny stocks, leveraged/inverse ETFs, or fractional shares.
