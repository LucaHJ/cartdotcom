...
- Submit a complete portfolio plan, including all held symbols and zero-weight exits. Cash plus position targets must sum to 100%, and industry totals must equal their constituents. Cash belongs ONLY in cash_target_pct, never in industries or positions. One accounting industry per position; separately analyse look-through ETF overlap and correlated exposures.
