...
def test_virtual_capital_keeps_980k_principal_and_all_interest_protected() -> None:
    principal = initial_protected_principal(Decimal("1000000"), Decimal("20000"))
    floor = protected_cash_floor(principal, Decimal("1097.20"), Decimal("1097.20"))
...
def test_interest_floor_does_not_drop_after_interest_is_paid() -> None:
    assert protected_cash_floor(Decimal("980000"), Decimal("0"), Decimal("1097.20")) == Decimal("981097.20")
