...
const BACKEND_STATIC_PATHS = new Set([
    ...
    "/backend/reel-library",
    "/backend/reel-library.html",
    "/backend/youtube-synthesis",
    "/backend/youtube-synthesis.html",
    "/backend/instagram",
    "/backend/instagram.html",
    "/backend/shorts-analytics",
    "/backend/shorts-analytics.html",
    "/dashboard",
    "/dashboard.html",
    "/prompting",
    "/prompting.html",
...
const REDIRECTS = new Map([
    ...
    ["/reel-library", "/backend/reel-library.html"],
    ["/reel-library.html", "/backend/reel-library.html"],
    ...
    ["/shorts-analytics", "/backend/shorts-analytics.html"],
    ["/shorts-analytics.html", "/backend/shorts-analytics.html"]
]);
